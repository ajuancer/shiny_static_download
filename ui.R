...
fluidPage(
  ...
  sidebarPanel(
    ...
    div(p(HTML(paste0('All the code and more information can be found at ', a(href = 'https://github.com/ajuancer/shinyapp_static_download', 'https://www.github.com/ajuancer/shinyapp_static_download'), '. Feel free to open an issue if you have any suggestion or problem.')))),

    h3('License'),
    div(p(HTML(paste0('Under the MIT license. Please reffer to ', a(href = 'https://github.com/ajuancer/shinyapp_static_download/LICENSE.md', 'the repository lincense'), ' for more information.')))),
